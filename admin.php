            ...
            <div class="services-wrapper">
              <form name="changeLetDestinacije" method="post" action="">
                  <div class="form-group">
                    ...
                    <div class="form-group ">
                      <input type="submit" name="izmeni" class="btn btn-custom-three  " value="Izmeni let">
                    </div>
                  </form>
                  <hr />
                    ...
                    <hr/>
                      <form name="galerija" method="post" action="novaSlikaGalerija.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group ">
                          <input type="submit" name="file" class="btn btn-custom-three " value="Ubaci">
                        </div>
                      </form>
                      <hr/>
                      <h3> Unos leta </h3>
					 ...
					 <div class="form-group">
                            ...
                            <div class="form-group ">
                              <input type="submit" name="unosLeta" class="btn btn-custom-three  " value="Dodaj let">
                            </div>
                          </form>
                          <br>
                          <hr>
